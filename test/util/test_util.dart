...
class TestUtil {
  ...
  static Future<Widget> loadFlotaApp(WidgetTester tester, {ThemeMode themeMode = ThemeMode.light}) async {
    return _internalLoadWidget(tester, const MyApp(), themeMode);
  }

  static T _getTheme<T>(BuildContext context) => FlotaTheme.of(context) as T;
