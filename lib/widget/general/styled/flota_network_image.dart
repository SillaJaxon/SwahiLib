...
class FlotaNetworkImage extends StatelessWidget {
  final String? url;
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return SizedBox(
          height: imgHeight,
          width: imgWidth,
          child: _FlotaBetterNetworkImage(
            imageUrl: correctUrl,
            height: imgHeight,
            width: imgWidth,
            fit: fit,
...
class _FlotaBetterNetworkImage extends StatefulWidget {
  ...
  const _FlotaBetterNetworkImage({
  ...
  @override
  _FlotaBetterNetworkImageState createState() => _FlotaBetterNetworkImageState();
}

class _FlotaBetterNetworkImageState extends State<_FlotaBetterNetworkImage> {
  ...
  @override
  void didUpdateWidget(_FlotaBetterNetworkImage oldWidget) {
