...
abstract class _$FlotaDb extends GeneratedDatabase {
  _$FlotaDb(QueryExecutor e) : super(e);
  _$FlotaDb.connect(DatabaseConnection c) : super.connect(c);
