...
import 'package:flota/styles/theme_fonts.dart';
import 'package:flota/util/theme/theme_config.dart';
import 'package:icapps_architecture/icapps_architecture.dart';

class FlotaThemeData {
  FlotaThemeData._();
...
class FlotaTextThemeExceptions {
  const FlotaTextThemeExceptions();
}

class FlotaColorsTheme {
  final Color text;
...
enum FlotaThemeStyle {
  dark,
  light,
}

class FlotaTheme {
  final FlotaTextTheme coreTextTheme;
  final FlotaTextTheme inverseCoreTextTheme;
  final FlotaTextTheme accentTextTheme;
  final FlotaTextThemeExceptions exceptionsTextTheme;
  final FlotaColorsTheme colorsTheme;
  ...
  static final _instanceDark = _fromColorTheme(
    isDarkTheme: true,
    colorTheme: const FlotaColorsTheme(
  ...
  static FlotaTheme _fromColorTheme({
    required FlotaColorsTheme colorTheme,
    required bool isDarkTheme,
  }) =>
      FlotaTheme._(
        isDarkTheme: isDarkTheme,
        colorsTheme: colorTheme,
        coreTextTheme: FlotaTextTheme(
        ...
        inverseCoreTextTheme: FlotaTextTheme(
        ...
        accentTextTheme: FlotaTextTheme(
        ...
        exceptionsTextTheme: const FlotaTextThemeExceptions(),
      );
  ...
  static FlotaTheme of(BuildContext context, {bool forceDark = false, bool forceLight = false}) {
